...
//    [self createAdMobView];
    ...
    self.titlePPSegControl = [[PPSegmentControl alloc]initWithItems:titleArray defaultSelectIndex:1 frame:CGRectMake(0, 0, 306, 33)];
...
- (CGRect)getProductListViewRect
{
    CGRect rect = self.view.bounds; // CGRectMake(0, 0, 320, self.view.bounds.size.height - 50);
    return rect;
}
...
- (void)showTopZeroTen
{
    if (self.belowTenController == nil){
        ...
        self.belowTenController.view.frame = [self getProductListViewRect];        
...
- (void)showTopTen
{
    if (self.aboveTenController == nil){
        ...
        self.distanceController.type = [titlePPSegControl titleForSegmentAtIndex:[titlePPSegControl selectedSegmentIndex]];
        self.aboveTenController.view.frame = [self getProductListViewRect];        
...
- (void)showTopNew
{
    if (self.topNewController == nil){
        ...
        self.distanceController.type = [titlePPSegControl titleForSegmentAtIndex:[titlePPSegControl selectedSegmentIndex]];
        self.topNewController.view.frame = [self getProductListViewRect];        
...
- (void)showProductByDistance
{
    if (self.distanceController == nil){
        ...
        self.distanceController.type = [titlePPSegControl titleForSegmentAtIndex:[titlePPSegControl selectedSegmentIndex]];       
        self.distanceController.view.frame = [self getProductListViewRect];        
